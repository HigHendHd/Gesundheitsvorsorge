 ...
 */
public class TrainingsplanListenParser {
    ...
    private List readFeed(XmlPullParser parser) throws XmlPullParserException, IOException {
        ...
        parser.require(XmlPullParser.START_TAG, ns, "trainingsplaene");
    ...
    private ListenEintrag readRezept(XmlPullParser parser) throws XmlPullParserException, IOException {
        parser.require(XmlPullParser.START_TAG, ns, "trainingsplan");
        String name = null;
        String bildUrl = null;
        String url = null;
        String info = null;
