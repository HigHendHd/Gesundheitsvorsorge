 ...
 */
public class AerzteFinderFragment extends MapFragment implements LocationListener, OnMapReadyCallback, DownloadXmlTask.XmlDownloader, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    public static AerzteFinderFragment newInstance() {
        AerzteFinderFragment frag = new AerzteFinderFragment();
        return frag;
    }
